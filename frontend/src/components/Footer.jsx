    ...
    <footer className="site-footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <section id="register" aria-labelledby="register-heading"><h2 id="register-heading">See you at STEAM Con.</h2><p>Registration details coming soon.<br />Dates and location to be announced.</p></section>
