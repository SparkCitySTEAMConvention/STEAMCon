    ...
    <footer className="site-footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <section id="travel" aria-labelledby="travel-heading"><h2 id="travel-heading">Plan your visit</h2><p><Link to="/travel">Explore New York travel information.</Link><br />Exact venue and dates to be announced.</p></section>
        </div>
